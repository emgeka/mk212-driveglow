...
DriveGlow re-registers the notification icon a few seconds after sign-in and
automatically restores it when Windows Explorer or the taskbar is restarted.
